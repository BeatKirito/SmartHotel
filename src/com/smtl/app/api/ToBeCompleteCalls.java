...
/**
 * Servlet implementation class ToBeCompleteCalls
 */
public class ToBeCompleteCalls extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			//第二步：根据工作人员的职务类型，获取该用户的待完成呼叫列表
			baseResult.setData(cusCallManage.loadToBeComCalls(sUserWT.getUserID()));
